...
/**
 *
 * @param {*} props Used for get IMDB ID from URL
 * @return Web component for single movie detail page
 */
          ...
          <div className={classes.content}>
            <div className={classes.header}>
              ...
              <div className={classes.rating}>
                ...
                <Typography variant="h2" className={classes.ratingText}>
                  {movie.Runtime}
                </Typography>
              </div>
            </div>
            ...
            <div className={classes.plot}>
              <Typography className={classes.plotTitle} color="primary">
                Synopsis
              </Typography>
              <Typography variant="body2" className={classes.plotDescription}>
                {movie.Plot}
              </Typography>
            </div>
          </div>
